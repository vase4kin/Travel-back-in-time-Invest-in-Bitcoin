...
import com.travelbackintime.buybitcoin.time_travel.view.TimeTravelViewImpl;

import dagger.Binds;
import dagger.Module;

@Module
public abstract class TimeTravelFragmentModule {

    @Binds
    abstract TimeTravelView providesTimeTravelView(TimeTravelViewImpl presenter);

    @Binds
    abstract TimeTravelRouter providesRouter(TimeTravelRouterImpl router);
}
